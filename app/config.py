...
class Settings:
    # --- GCP CONFIG ---
    PROJECT_ID = os.getenv("PROJECT_ID", "enterprise-rag-496810")
    ...
    RAW_BUCKET = os.getenv("GCP_RAW_BUCKET", "enterprise-rag-496810-raw")
    PROCESSED_BUCKET = os.getenv("GCP_PROCESSED_BUCKET", "enterprise-rag-496810-processed")
